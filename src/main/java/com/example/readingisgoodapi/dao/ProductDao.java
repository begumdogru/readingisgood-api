...
public class ProductDao {
    ...
    public boolean saveProduct(Product product) {
        String sql = "INSERT INTO product (pid, pname, price, qty) VALUES (?, ?, ?, ?)";

        int value = jdbcTemplate.update(sql, new Object[]{product.getPid(), product.getPname(), product.getPrice(), product.getQty()});
